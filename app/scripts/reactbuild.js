...
var ListInstance = React.createClass({displayName: "ListInstance",
  ...
  render: function() {
    ...
    $.each(this.state.countries, function(key, value) {
        ...
        var listItem = React.createElement(ListGroupItem, null, " ", React.createElement("i", {className: countryIcon}), " ", value, " ", React.createElement("i", {className: checkIcon, onClick: self.handleClick.bind(this, key)}), " ");
    ...
    var countryColors = {};
    $.each(this.state.countries, function(key, value){
      var countryCode = key.toLowerCase();
    ...
    return (
      React.createElement("div", {className: "worldContainer"}, 
        React.createElement("div", {id: "map"}, 
          React.createElement(WorldMap, {countries: this.props.countries, checkedCountries: this.state.checked, countryColors: countryColors})
        ), 
        React.createElement("select", {className: "form-control"}, 
          React.createElement("option", {value: "Africa"}, "Africa"), 
          React.createElement("option", {value: "The Americas"}, "The Americas"), 
          React.createElement("option", {value: "Europe"}, "Europe"), 
          React.createElement("option", {value: "Asia"}, "Asia"), 
          React.createElement("option", {value: "Australia and the Pacific"}, "Australia and the Pacific")
        ), 
...
var WorldMap = React.createClass({displayName: "WorldMap",
...
React.render(React.createElement(ListInstance, {countries: [{name:'Italy', abbr: 'it', checked: false}, {name: 'Canada', abbr: 'ca', checked: false}, {name: 'Kenya', abbr: 'ke', checked: true}]}), document.getElementById('reactStuff'));

},{"react-bootstrap-multiselect":5}],2:[function(require,module,exports){
...
},{"./bootstrap-dropdown.js":2,"./bootstrap-multiselect.js":3,"./get-options.js":4,"jquery":6,"react":152}],6:[function(require,module,exports){
/*!
