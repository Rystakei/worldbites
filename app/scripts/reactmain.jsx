...
var ListInstance = React.createClass({
  ...
  getInitialState: function() {
    var countries = ['All', 'Africa', 'Asia', 'Europe', 'South America', 'North America', 'Australia and the Pacific'];
    var list = [];
  ...
  render: function() {
    ...
    $.each(this.state.countries, function(key, value) {
        ...
        var countryStats = <div className="country-stats"> <p><b>30</b> Italian restaurants near <a href="#"><b>02143</b></a></p></div>;
        var wikiPage = <div className="wiki-page"><a href="#"> Learn about Italian cuisine on Wikipedia </a></div>;
        var listItem = <ListGroupItem className="country-item"> <i className={countryIcon}></i> {value} <i className={checkIcon} onClick={self.handleClick.bind(this, key)}></i> {countryStats} {wikiPage} </ListGroupItem>;
...
var BootstrapSelect = React.createClass({
    ...
    render: function() {
        var regions = {ar: 'All', af: 'Africa', as: 'Asia', eu:'Europe', sa:'South America',na: 'North America',oc: 'Oceania'};
        var options = [];
